...
from app.models import session  # noqa: F401 — registers the model with Base.metadata
...
# Migrations run against the direct (non-pooled) connection — some DDL operations
# don't play well through Neon's pgbouncer pooler.
